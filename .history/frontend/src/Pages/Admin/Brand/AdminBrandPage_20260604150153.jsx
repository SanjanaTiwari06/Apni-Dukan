            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h6 className='mybackground text-light text-center p-2 fs-1 mb-3'>Brand
                            <Link to="/admin/brand/create"><i className='bi bi-plus text-light fs-1 float-end'></i></Link>
                        </h6>
                                ...
                                <tbody>
                                    {data.map(item => {
                                        return <tr key={item._id}>
                                            ...
                                            <td><Link to={`/admin/brand/update/${item._id}`} className='btn btn-primary mybackground'><i className='bi bi-pencil fs-3'></i></Link></td>
